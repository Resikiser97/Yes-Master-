...
- **現在版本**：v0.0.5.0
- **當前狀態**：MVP 單機可動。移動 / 挖礦 / 背包 / 塔內資源 / 跟隨鏡頭 / 初版建造 / 核心數值回饋 / 核心 HP 與修復 / 核心戰鬥 / 正式波次晝夜 / 卡片選擇 / localStorage 存檔 / 新手教學提示已成完整循環。
- **下一步（最多 4 條）**：
  1. 掉落物系統：背包滿可繼續挖、溢出塊掉地上可撿回。
  2. 卡片 UI 手感精調：面板字體 / 色彩 / hover 效果。
  3. 多人接入準備：PeerJS Star 拓撲骨架。
  4. Supabase 帳號系統接入。
