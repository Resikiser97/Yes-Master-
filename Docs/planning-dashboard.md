...
| 多人合作分工（Must Solve 6） | ✅ | MVP版定案：不強制分工、不額外懲罰；多人意圖Emoji/ping wheel，⛏️挖礦、🧱建築、🦵搬運、🔧修復、⚠️危險回防；房員欄與角色頭上顯示30秒 |
...
| 新手教學／Onboarding流程 | ✅ | 7個MVP觸發點（情境教學一次/失敗提示每次）+重看教學入口；特別處理泥土連通性非直覺規則，已同步進 game-architecture-plan.md |
