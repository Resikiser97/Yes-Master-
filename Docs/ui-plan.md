...
> 狀態：實作中（v0.0.15.0 已完成 HUD 密度整理 / 波次情報展開 / 手機意圖入口）
> 最後更新：2026-06-27
> 版本：v0.0.15.0
...
| 區塊 | 原因 | 實裝時機 |
|---|---|---|
| **B. 隊友列** | ✅ 已實裝（疲勞條 + 意圖 Emoji）；intent 同步已加入 stateSync / inputBuffer manualIntent | — |
| **F. 敵人情報面板** | ✅ v0.0.15.0 實裝可展開/收合；收合看當前波，展開看下一波預覽 | — |
